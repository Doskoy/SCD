// *****************************************************************************
// Practica 1: Productor-consumidor con buffer intermedio. Solucion LIFO
...
sem_t existe_hueco;		//inicializado a tam_vector
...
void * funcion_productor( void * )
{
  for( unsigned i = 0 ; i < num_items ; i++ )
  {
    ...
    vector_compartido[primera_libre] = dato;
    sem_wait (&mutex);
...
void * funcion_consumidor( void * )
{
  for( unsigned i = 0 ; i < num_items ; i++ )
  {
    ...
    primera_libre--;      //Variable que almacena la direccion en vector del siguiente dato que sera consumido   
    dato = vector_compartido[primera_libre];
    consumir_dato(dato);
    sem_wait (&mutex);
